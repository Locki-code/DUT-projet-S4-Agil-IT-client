...
export class CreerJeuComponent implements OnInit {
  ...
  /*themes: Themes[] = [ {"id":1,"nom":"Abstrait, lettres \u0026 mots"},{"id":2,"nom":"Animaux \u0026 Nature"},{"id":3,"nom":"Autres"},{"id":4,"nom":"Cartoon \u0026 Dessin"},
  ...
  editeurs: Editeur[] = [ {"id":1,"nom":"1-2-3-Games"},{"id":2,"nom":"ADG"},{"id":3,"nom":"Arkhane Asylum Publishing"},{"id":4,"nom":"Bayard Jeux"},{"id":5,"nom":"Blue Orange"},
  ...
  mecaniques: Mecanique[] = [{"id":1,"nom":"Abstrait"},{"id":2,"nom":"Humour"},{"id":3,"nom":"Jeu de plateau"},{"id":4,"nom":"Enquêtes \u0026 Mystères"},{"id":5,"nom":"Antiquité"},
